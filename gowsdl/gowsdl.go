...
var xsd2GoTypes = map[string]string{
	...
	"xs:time":               "XsTime",
	"xs:date":               "XsDate",
	"xs:gyearmonth":         "XsGYearMonth",
	"xs:gyear":              "XsGYear",
	"xs:gmonthday":          "XsGMonthDay",
	"xs:gday":               "XsGDay",
	"xs:gmonth":             "XsGMonth",
	...
	"xs:anyuri":             "XsAnyURI",
	"xs:qname":              "XsQName",
	"xs:notation":           "XsNOTATION",
	"xs:string":             "XsString",
	"xs:normalizedstring":   "XsNormalizedString",
	"xs:token":              "XsToken",
	"xs:language":           "XsLanguage",
	"xs:name":               "XsName",
	"xs:ncname":             "XsNCName",
	"xs:id":                 "XsID",
	"xs:idref":              "XsIDREF",
	"xs:idrefs":             "XsIDREFS",
	"xs:entity":             "XsENTITY",
	"xs:entities":           "XsENTITIES",
	"xs:nmtoken":            "XsNMTOKEN",
	"xs:nmtokens":           "XsNMTOKENS",
	"xs:decimal":            "XsDecimal",
	"xs:integer":            "XsInteger",
	"xs:nonpositiveinteger": "XsNonPositiveInteger",
	"xs:negativeinteger":    "XsNegativeInteger",
	"xs:long":               "XsLong",
	"xs:int":                "XsInt",
	"xs:short":              "XsShort",
	"xs:byte":               "XsByte",
	"xs:nonnegativeinteger": "XsNonNegativeInteger",
	"xs:unsignedlong":       "XsUnsignedLong",
	"xs:unsignedint":        "XsUnsignedInt",
	"xs:unsignedshort":      "XsUnsignedShort",
	"xs:unsignedbyte":       "XsUnsignedByte",
	"xs:positiveinteger":    "XsPositiveInteger",
}
...
func toGoType(xsdType string, nillable bool) string {
	...
	idx := strings.IndexByte(xsdType, ':')
	if idx != -1 {
		xsdType = xsdType[idx:]
	}
	return "*" + replaceReservedWords(makePublic(xsdType))
}
